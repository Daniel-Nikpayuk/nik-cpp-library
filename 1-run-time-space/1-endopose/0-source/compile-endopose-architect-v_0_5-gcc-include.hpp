...
#ifndef NIK_COMPILE_ENDOPOSE_ARCHITECT_V_0_5_GCC_HPP
#define NIK_COMPILE_ENDOPOSE_ARCHITECT_V_0_5_GCC_HPP
...
// dependencies:
	...
	#include nik_source(../../.., compile, compose, architect, v_0_5, gcc)
...
namespace nik
{
	nik_begin_module(compile, endopose, architect, v_0_5, gcc)
	...
	nik_end_module(compile, endopose, architect, v_0_5, gcc)
}
