...
#ifndef NIK_COMPILE_PROCEDURE_ARCHITECT_V_0_5_GCC_HPP
#define NIK_COMPILE_PROCEDURE_ARCHITECT_V_0_5_GCC_HPP
...
namespace nik
{
	nik_begin_module(compile, procedure, architect, v_0_5, gcc)
	...
	nik_end_module(compile, procedure, architect, v_0_5, gcc)
}
