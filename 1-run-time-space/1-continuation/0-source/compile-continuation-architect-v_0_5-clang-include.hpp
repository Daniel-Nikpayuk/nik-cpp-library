...
#ifndef NIK_COMPILE_CONTINUATION_ARCHITECT_V_0_5_CLANG_HPP
#define NIK_COMPILE_CONTINUATION_ARCHITECT_V_0_5_CLANG_HPP
...
// dependencies:
	...
	#include nik_source(../../.., compile, procedure, architect, v_0_5, clang)
...
namespace nik
{
	nik_begin_module(compile, continuation, architect, v_0_5, clang)
	...
	nik_end_module(compile, continuation, architect, v_0_5, clang)
}
