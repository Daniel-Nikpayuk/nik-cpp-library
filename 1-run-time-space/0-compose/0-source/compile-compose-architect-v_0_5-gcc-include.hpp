...
#ifndef NIK_COMPILE_COMPOSE_ARCHITECT_V_0_5_GCC_HPP
#define NIK_COMPILE_COMPOSE_ARCHITECT_V_0_5_GCC_HPP
...
namespace nik
{
	nik_begin_module(compile, compose, architect, v_0_5, gcc)
	...
	nik_end_module(compile, compose, architect, v_0_5, gcc)
}
