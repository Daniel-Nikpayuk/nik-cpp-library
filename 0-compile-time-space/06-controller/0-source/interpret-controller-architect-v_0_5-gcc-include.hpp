...
#ifndef NIK_INTERPRET_CONTROLLER_ARCHITECT_V_0_5_GCC_HPP
#define NIK_INTERPRET_CONTROLLER_ARCHITECT_V_0_5_GCC_HPP
...
namespace nik
{
	nik_begin_module(interpret, controller, architect, v_0_5, gcc)
