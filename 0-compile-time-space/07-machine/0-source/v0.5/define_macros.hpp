...
/***********************************************************************************************************************/
	...
	#define NIK_BEGIN_INTERNAL(_d_, _n_, _c_, _i_, _j_)								\
															\
		NIK_BEGIN_AUTOMATA(_d_, MT::internal, _n_, _c_, _i_, _j_)
	...
	#define NIK_INTERNAL(_d_, _n_, _c_, _i_, _j_, _v_)								\
															\
		NIK_AUTOMATA(_d_, MT::internal, _n_, _c_, _i_, _j_, _v_)
		...
		{													\
			...
			{												\
				...
				constexpr auto ins	= tn::instr(c, i, j);						\
															\
				if constexpr (ins[BI::policy] == CP::drop)						\
															\
					return NIK_MACHINE(d, n, c, i, j, Vs)(H0, H1, Hs...);				\
				else											\
					return NIK_MACHINE(d, n, c, i, j, Vs)						\
						(H0, U_opt_pack_Vs<Xs..., NIK_2_N_VARS(_n_, V)>, Hs...);		\
			}												\
		}
...
// move argument block (2^N):
	...
	#define NIK_DEFINE__MOVE_A_BLOCK(_n_)										\
															\
		template<key_type... filler>										\
		struct machine<MN::move_a_block, _n_, filler...>							\
		{													\
			template											\
			<												\
				NIK_CONTR_PARAMS, auto... Vs,								\
				typename Heap0, typename Heap1, auto... Ys, typename Heap3, typename Heap4,		\
				NIK_2_N_TYPENAME_VARS(_n_, Arg), typename... Args					\
			>												\
			static constexpr auto result									\
			(												\
			...
			{												\
				...
				if constexpr (ins[BI::policy] == CP::drop)						\
															\
					return NIK_MACHINE(d, n, c, i, j, Vs)(H0, H1, H2, H3, H4, As...);		\
				else											\
					return NIK_MACHINE(d, n, c, i, j, Vs)						\
					(										\
						H0, H1,									\
...
// catenate argument block (2^N):
	...
	#define NIK_DEFINE__CATENATE_A_BLOCK(_n_)									\
															\
		template<key_type... filler>										\
		struct machine<MN::catenate_a_block, _n_, filler...>							\
		{													\
			template											\
			<												\
				NIK_CONTR_PARAMS, auto... Vs,								\
				typename Heap0, typename Heap1, typename Heap2, typename Heap3, typename Heap4,		\
				auto... Ps, NIK_2_N_VARIADIC_VARS(_n_, Ps), typename... Args				\
			>												\
			static constexpr auto result									\
			(												\
...
// map argument block (2^N):
	...
	#define NIK_DEFINE__MAP_A_BLOCK(_n_)										\
															\
		template<key_type... filler>										\
		struct machine<MN::map_a_block, _n_, filler...>								\
		{													\
			template											\
			<												\
				NIK_CONTR_PARAMS, auto... Vs,								\
				auto W0, auto... Ws,									\
				typename Heap1, typename Heap2, typename Heap3, typename Heap4,				\
				NIK_2_N_VARIADIC_VARS(_n_, Ps), typename... Args					\
			>												\
			static constexpr auto result									\
			(												\
			...
			{												\
				...
				{											\
					...
					(										\
						...
						U_opt_pack_Vs								\
						<									\
							NIK_2_N_AL_MAP_VARS(_n_, alias, Ps)				\
						>,									\
															\
						As...									\
					);										\
				}											\
				else return NIK_MACHINE(d, n, c, i, j, Vs)						\
				(											\
					H0, H1, H2, H3, H4,								\
															\
					U_opt_pack_Vs									\
					<										\
						NIK_2_N_OP_MAP_VARS(_n_, W0, Ps)					\
					>,										\
															\
					As...										\
				);											\
...
// zip argument block (2^N):
	...
	#define NIK_DEFINE__ZIP_A_BLOCK(_n_)										\
															\
		template<key_type... filler>										\
		struct machine<MN::zip_a_block, _n_, filler...>								\
		{													\
			template											\
			<												\
				NIK_CONTR_PARAMS, auto... Vs,								\
			...
			{												\
				...
				{											\
					...
					(										\
						...
						U_opt_pack_Vs								\
						<									\
							NIK_2_N_ALS(_n_, alias) Ps, NIK_2_N_AL_VARS(_n_, Ps)...		\
						>,									\
															\
						As...									\
					);										\
				...
				(											\
					...
					U_opt_pack_Vs									\
					<										\
						NIK_2_N_OPS(_n_, W0) Ps, NIK_2_N_OP_VARS(_n_, Ps)...			\
					>,										\
															\
					As...										\
				);											\
