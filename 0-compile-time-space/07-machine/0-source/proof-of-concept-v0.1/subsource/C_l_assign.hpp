...
// 0:
	...
	<
		...
		auto R0, auto... Rs
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(0)>*))
	{
...
// 1:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(1)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 2:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(2)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 3:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(3)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 4:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(4)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 5:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(5)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 6:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(6)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 7:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(7)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 8:
	...
	<
		...
		auto R8, auto... Rs
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(8)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 9:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(9)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 10:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(10)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 11:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(11)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 12:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(12)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 13:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(13)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 14:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(14)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
...
// 15:
	...
	>
	constexpr auto machine(void(*)(auto_pack<RI::l_assign, index_type(15)>*))
	{
		constexpr auto V	= c(l)(m)(3);
		constexpr instr_type j	= next_i(d, c, l, m);
