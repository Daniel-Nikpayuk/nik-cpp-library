...
private:
	...
	struct linear_program<LN::at, filler...> : public linear_program<filler...>
	{
		...
		nik_ces label_type controller = label
		<
...
public:
	...
	template<auto d, auto n, auto... Vs>
	nik_ces auto right = f_right<d, n, Vs...>();
...
public:
	...
	template<auto d, auto pos, auto... Vs>
	nik_ces auto erase = f_erase<d, pos, Vs...>();
...
public:
	...
	template<auto d, auto pos, auto obj, auto... Vs>
	nik_ces auto insert = f_insert<d, pos, obj, Vs...>();
...
public:
	...
	template<auto d, auto pos, auto obj, auto... Vs>
	nik_ces auto replace = f_replace<d, pos, obj, Vs...>();
...
public:
	...
	template<auto d, auto n, auto... Vs>
	nik_ces auto left = f_left<d, n, Vs...>();
	...
	nik_ces auto f_roll()
	{
		...
		return machine_module::template
			start<linear_machine, c, d, V0, Vs...>
				(store_module::template U_pack_Vs<length, uact>);
	}

public:

	template<auto d, auto uact, auto V0, auto... Vs>
	nik_ces auto roll = f_roll<d, uact, V0, Vs...>();
