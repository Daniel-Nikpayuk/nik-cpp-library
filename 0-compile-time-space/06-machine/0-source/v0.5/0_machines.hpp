...
/***********************************************************************************************************************/
	...
	struct MachineName
	{
		...
		// passers:
			...
			static constexpr key_type shift_r_block__insert_at_s_back		=  8; // <machine>
			...
			static constexpr key_type copy_s_block__insert_at_h2_front		= 26; // <machine>
			static constexpr key_type copy_s_pos__insert_at_h2_front		= 27; // opt, <machine>

			// heap -> stack:

			static constexpr key_type move_h0_first__insert_at_s_front		= 28; // <mutators>
			static constexpr key_type move_h0_first__insert_at_s_pos		= 29; // opt, <mutators>
			static constexpr key_type move_h0_first__replace_at_s_pos		= 30; // opt, <mutators>

			static constexpr key_type move_h1_all__insert_at_s_front		= 31; // <mutators>
			static constexpr key_type move_h1_all__value_at_s_front			= 32; // <near linear>

			static constexpr key_type move_h2_first__insert_at_s_front		= 33; // <mutators>
			static constexpr key_type move_h2_first__replace_at_s_pos		= 34; // opt, <mutators>

			static constexpr key_type apply_h0_all__move__insert_at_s_front		= 35; // opt, <machine>
			static constexpr key_type apply_h0_all__move__replace_at_s_pos		= 36; // opt, <machine>

			static constexpr key_type compel_h0_all__move__insert_at_s_front	= 37; // opt, <machine>
			static constexpr key_type compel_h0_all__move__replace_at_s_pos		= 38; // opt, <machine>

			// heap -> heap:

			static constexpr key_type apply_h0_all__move__replace_at_h0_front	= 39; // opt, <machine>

			static constexpr key_type compel_h0_all__move__replace_at_h0_front	= 40; // opt, <machine>

		// interposers:

			static constexpr key_type copy_i_pos__insert_at_h0_front		= 41; // <machine>

			static constexpr key_type branch					= 42; // <machine>
			static constexpr key_type go_to						= 43; // <machine>
...
// move stack first, replace heap one value:
	...
	struct machine<MN::move_s_first__replace_at_h1_value, _zero, filler...>
	{
		template
		<
			NIK_CONTR_PARAMS, auto V0, auto... Vs,
...
// copy stack block, insert at heap two front (2^N):
	...
	NIK_DEFINE__COPY_S_BLOCK__INSERT_AT_H2_FRONT(0);

/***********************************************************************************************************************/

// copy stack position, insert at heap two front (optimization):

	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(1, 0);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(2, 1);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(3, 2);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(4, 3);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(5, 4);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(6, 5);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(7, 6);
	NIK_DEFINE__COPY_S_POS__INSERT_AT_H2_FRONT(8, 7);
...
// move heap two first, insert at stack front:

	template<key_type... filler>
	struct machine<MN::move_h2_first__insert_at_s_front, _zero, filler...>
	{
		template
		<
			NIK_CONTR_PARAMS, auto... Vs,
...
// move heap two first, replace at stack position (optimization):
	...
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(1, 0, 0);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(2, 1, 1);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(3, 2, 1);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(4, 3, 1);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(5, 4, 1);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(6, 5, 1);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(7, 6, 1);
	NIK_DEFINE__MOVE_H2_FIRST__REPLACE_AT_S_POS(8, 7, 1);
...
// apply heap zero all, move, replace at heap zero front:

	template<key_type... filler>
	struct machine<MN::apply_h0_all__move__replace_at_h0_front, _zero, filler...>
	{
		template<NIK_CONTR_PARAMS, auto... Vs, auto op, auto... args, typename... Heaps>
		static constexpr auto result(void(*H0)(auto_pack<op, args...>*), Heaps... Hs)
		{
...
// compel heap zero all, move, replace at heap zero front:
...
// copy instruction position, insert at heap zero front:

	template<key_type... filler>
	struct machine<MN::copy_i_pos__insert_at_h0_front, _zero, filler...>
	{
		template<NIK_CONTR_PARAMS, auto... Vs, auto... Ws, typename... Heaps>
		static constexpr auto result(void(*H0)(auto_pack<Ws...>*), Heaps... Hs)
		{
			return NIK_MACHINE(n, c, d, i, j)(U_opt_pack_Vs<n::val(c, i, j), Ws...>, Hs...);
		}
	};
