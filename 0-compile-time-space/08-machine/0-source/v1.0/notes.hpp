...
// is store level 0:
	...
	// it's store level 0 if (refactored):
...
// is store level 1:
	...
	// it's store level 1 if (refactored):
...
// constexpr monad:
	...
	//			return machine
	//			<
	//				next_name<T_store_U<n>>(d, m, c, i, j),
	//				next_note<T_store_U<n>>(d, m, c, i, j)

	//			>::template result
	//			<
	//				next_depth(d),
	//				m, n, c,
	//				next_index1<T_store_U<n>>(d, m, c, i, j),
	//				next_index2<T_store_U<n>>(d, m, c, i, j)
