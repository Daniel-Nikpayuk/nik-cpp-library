...
private:
	...
	static constexpr auto shift = V + n;

	template<auto n, auto... Vs, auto... Ws>
	static constexpr auto U_make_consecutive_UxU(void(*)(auto_pack<Vs...>*), void(*)(auto_pack<Ws...>*))
	{
		return U_pack_Vs<Vs..., shift<Ws,n>...>;
	}

public:

	template<auto TMap1, auto TMap2, auto n>
	static constexpr auto U_consecutive_UxU = U_make_consecutive_UxU<n>(TMap1, TMap2);
