...
#ifndef NIK_INTERPRET_REFERENCE_ARCHITECT_V_1_0_CLANG_HPP
#define NIK_INTERPRET_REFERENCE_ARCHITECT_V_1_0_CLANG_HPP

// dependencies:

#define NIK_STORE_VERSION v_1_0
#define NIK_STORE_VENDOR clang
...
#define NIK_MODULE nik_module(interpret, reference, architect, NIK_VERSION, NIK_VENDOR)

	#include nik_local(interpret, reference, architect, NIK_VERSION)
