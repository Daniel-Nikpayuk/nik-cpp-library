...
#ifndef NIK_INTERPRET_CONSTANT_ARCHITECT_V_0_5_GCC_HPP
#define NIK_INTERPRET_CONSTANT_ARCHITECT_V_0_5_GCC_HPP
...
namespace nik
{
	nik_begin_module(interpret, constant, architect, v_0_5, gcc)
