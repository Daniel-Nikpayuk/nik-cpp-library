...
#ifndef NIK_INTERPRET_POINTER_ARCHITECT_V_1_0_CLANG_HPP
#define NIK_INTERPRET_POINTER_ARCHITECT_V_1_0_CLANG_HPP
...
#define NIK_MODULE nik_module(interpret, pointer, architect, NIK_VERSION, NIK_VENDOR)

	#include nik_local(interpret, pointer, architect, NIK_VERSION)
